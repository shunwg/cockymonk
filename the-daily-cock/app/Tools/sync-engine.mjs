#!/usr/bin/env node
// One-way copy from the-daily-cock/js/ — see the-daily-cock/CLAUDE.md
// "Provenance" and the-daily-cock/Tools/build-words.mjs / sync-tokens.mjs for
...
const srcDir = path.join(here, "..", "..", "js"); // the-daily-cock/js/
const outDir = path.join(here, "..", "src", "engine"); // the-daily-cock/app/src/engine/

const FILES = ["engine.js", "config.js", "decoys.js", "rating.js"];
const banner = (name) =>
  `// GENERATED FILE — copied verbatim from the-daily-cock/js/${name} by\n` +
