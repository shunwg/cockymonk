...
const STRINGS = {
  no: {
    ...
    back: "Tilbake",
    aboutSectionTitle: "Om",
    aboutLinkLabel: "Om Cockerel",
    aboutHeading: "Om Cockerel",
    aboutBlurb: "Cockerel er et daglig ordspill: du skriver bløffer for dagens ord, og gjetter det riktige svaret på gårsdagens.",
    aboutWordsHeading: "Ordkilder",
    aboutWordsIntro: "Ordforklaringene i spillet kommer fra åpne ordbøker. Takk til dem som har gjort dem tilgjengelige:",
    aboutCorpusLine: "{count} ord",
    aboutCreditsUnavailable: "Klarte ikke å hente kildeinformasjonen akkurat nå.",
  ...
  en: {
    ...
    aboutLinkLabel: "About Cockerel",
    aboutHeading: "About Cockerel",
    aboutBlurb: "Cockerel is a daily word game: you write bluffs for today's words, and guess the real answer for yesterday's.",
    aboutWordsHeading: "Word sources",
    aboutWordsIntro: "The definitions in this game come from open dictionaries. Thanks to the people who made them available:",
    aboutCorpusLine: "{count} words",
    aboutCreditsUnavailable: "Couldn't load the source information right now.",
