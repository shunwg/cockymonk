...
const STRINGS = {
  no: {
    ...
    installIOSInstructions: "Trykk på Del-ikonet nederst i Safari, og velg «Legg til på Hjem-skjerm».",
  ...
  en: {
    ...
    installIOSInstructions: "Tap the Share icon in Safari, then choose “Add to Home Screen.”",
